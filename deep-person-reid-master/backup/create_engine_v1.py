...
def get_engine(max_batch_size=1, onnx_file_path="", engine_file_path="", \
    ...
    def build_engine(max_batch_size, save_engine):
        ...
        with trt.Builder(TRT_LOGGER) as builder, \
            ...
            # config.max_workspace_size = 1 << 50  # Your workspace size
...
if __name__ == '__main__':
    ...
    filename = 'Lenna.jpg'
    max_batch_size = 1
    onnx_model_path = 'osnet_ain_x1_0_sim.onnx'
    ...
    fp16_mode = True
    int8_mode = False
    trt_engine_path = 'osnet_ain_x1_0_sim.engine'
    # Build an engine
    ...
    # Do inference
    shape_of_output = (max_batch_size, 512)
